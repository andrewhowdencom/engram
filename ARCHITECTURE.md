...
│                                                              │
│  ┌──────────────────┐    ┌──────────────────┐    ┌──────────────────┐
│  │   Go Library     │    │      CLI         │    │   MCP Server     │
│  │  (pkg/engram)    │    │   (cmd/engram)   │    │   (cmd/engram)   │
│  │                  │    │                  │    │                  │
│  │  Store interface │    │  query           │    │  mcp stdio       │
│  │  Memory type     │    │  store           │    │  mcp http        │
│  │  Query type      │    │  link            │    │                  │
│  │  Focus type      │    │  focus (agent-   │    │  memory_store    │
│  │  Link type       │    │      managed)    │    │  memory_query    │
│  └────────┬─────────┘    └────────┬─────────┘    │  memory_link     │
│           │                       │                       │
│           └───────────┬───────────┘                       │
│                       │                                    │
...
| Interface | Status |
|---|---|
| MCP server (`memory_query`, `memory_store`, `memory_link`) | **Implemented** (stdio + HTTP/SSE) |
